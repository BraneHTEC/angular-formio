...
export declare class FormioGridComponent implements OnChanges, OnInit, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FormioGridComponent, "formio-grid", never, { "footerPosition": "footerPosition"; "src": "src"; "items": "items"; "onForm": "onForm"; "query": "query"; "refresh": "refresh"; "columns": "columns"; "gridType": "gridType"; "size": "size"; "components": "components"; "formio": "formio"; "label": "label"; "createText": "createText"; "isActionAllowed": "isActionAllowed"; }, { "select": "select"; "rowSelect": "rowSelect"; "rowAction": "rowAction"; "createItem": "createItem"; "error": "error"; }, never, never, false>;
}
