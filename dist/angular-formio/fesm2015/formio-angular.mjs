...
class FormioBaseComponent {
    ...
    getRendererOptions() {
        ...
        return assign({}, Object.assign(Object.assign({ icons: get(this.config, 'icons', 'fontawesome'), noAlerts: get(this.options, 'noAlerts', true), readOnly: this.readOnly, viewAsHtml: this.viewOnly }, (this.viewOnly && { renderMode: "html" })), { i18n: get(this.options, 'i18n', null), fileService: get(this.options, 'fileService', null), hooks: this.hooks, sanitizeConfig: {
                addTags: extraTags
            }, dataTableActions: this.dataTableActions }), this.renderOptions || {});
    }
    createRenderer() {
